...
@lesson/studteach[
     ...
     #:standards (list)
     #:materials @itemlist[]
     #:preparation @itemlist[@item{OPTIONAL: Hand out @(hyperlink "https://docs.google.com/document/d/19xhODWaIG4HlupzaUuNf_BNscJFSdlSRJZWpBAxWDsM/edit?usp=sharing" "Warmup activity sheet").}]
     #:pacings (list 
